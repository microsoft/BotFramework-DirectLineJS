...
import {
    Activity, ActivityGroup, AnimationCard, AdaptiveCard, Attachment,
    AttachmentLayout, AudioCard, CallCardAction, CardAction, CardActionTypes,
    CardImage, Conversation, DownloadFileCardAction, EventActivity, FlexCard,
    HeroCard, IActivity, IMBackCardAction, KnownMedia, Media,
    MediaType, Message, MessageBackCardAction, MessageBackWithImage, MessageBackWithTitle,
    OAuth, OpenURLCardAction, PlayAudioCardAction, PlayVideoCardAction, PostBackCardAction,
    ReceiptItem, Receipt, ShowImageCardAction, Signin, SignInCardAction,
    Thumbnail, Typing, UnknownMedia, User, UserRole, VideoCard
} from './types';
