...
- Direct Line Streaming: Added `watchdog` option to assist detection of connection issues, by [@compulim](https://github.com/compulim), in PR [#XXX](https://github.com/microsoft/BotFramework-DirectLineJS/pull/XXX)
