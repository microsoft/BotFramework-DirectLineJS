...
var directLine = new DirectLine({
    ...
    mapActivity: /* optional: a function that takes in an Activity and returns an Activity. This is useful for adding custom parameters to send to your bot service.  */
});
```
